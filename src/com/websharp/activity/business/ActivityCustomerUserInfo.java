...
public class ActivityCustomerUserInfo extends FragmentActivity implements View.OnClickListener {
	...
	LinearLayout layout_order_package;
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.layout_order_package:
			showFragment(layout_order_package);
			break;
	...
	public void init() {
		...
		layout_order_package = (LinearLayout) findViewById(R.id.layout_order_package);
	...
	public void bindData() {
		...
		for (int i = 0; i < GlobalData.listClientConfig.size(); i++) {
			...
			if (id == 1) {
				if (value.equals("1")) {
					layout_order_package.setBackgroundResource(R.drawable.bg_btn_system);
					layout_order_product.setBackgroundResource(R.drawable.bg_btn_system);
					layout_order_package.setOnClickListener(this);
					layout_order_product.setOnClickListener(this);
				} else {
					layout_order_package.setBackgroundResource(R.drawable.bg_btn_disabled);
					layout_order_product.setBackgroundResource(R.drawable.bg_btn_disabled);
				}
			} else if (id == 2) {
				if (value.equals("1")) {
					layout_change_device.setBackgroundResource(R.drawable.bg_btn_system);
					layout_change_device.setOnClickListener(this);
				} else {
					layout_change_device.setBackgroundResource(R.drawable.bg_btn_disabled);
				}
			} else if (id == 4) {
				if (value.equals("1")) {
					layout_send_auth.setBackgroundResource(R.drawable.bg_btn_system);
					layout_send_auth.setOnClickListener(this);
				} else {
					layout_send_auth.setBackgroundResource(R.drawable.bg_btn_disabled);
				}
			}
		}
	...
	private void showFragment(View pressBtn) {
		...
		case R.id.layout_order_package:
			if (fragOrderPackage == null) {
				fragOrderPackage = new FragmentOrderPackage();
			}
			transaction.replace(R.id.container_fragment, fragOrderPackage);
			break;
		case R.id.layout_order_product:
