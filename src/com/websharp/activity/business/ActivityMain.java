...
public class ActivityMain extends BaseActivity {
	...
	LinearLayout layout_zlcx, layout_khcx, layout_ggck, layout_cancel, layout_work_log;
	TextView tv_cancel;
	...
	public void bindData() {
		...
		baseSetOnClickListener(this, layout_back, btn_qr, btn_search, tv_dept, layout_cancel, layout_ggck, layout_khcx,
				layout_zlcx, layout_work_log, btn_update_download_exit);
		...
		// if(GlobalData.listClientConfig.size() == 0){
	...
	public void checkUpdateApk() {
		new SwzfHttpHandler(cbCheckVersion, ActivityMain.this).checkVersion();
	}
