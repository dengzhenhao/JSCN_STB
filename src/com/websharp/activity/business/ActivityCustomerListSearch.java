	...
	class AdapterCustomer extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.tv_customer_address
					.setText(mList.get(position).REGION_NAME1 + AppUtil.GetNullValue(mList.get(position).REGION_NAME2)
			...
			//Util.createToast(ActivityCustomerListSearch.this, c, 1500).show();
			if (c == null || c.isEmpty() || ConvertUtil.ParsetStringToInt32(c, 0) <= 0) {
				//Util.createToast(ActivityCustomerListSearch.this, "设置为灰色", 1500).show();
